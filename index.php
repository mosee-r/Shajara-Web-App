...
<body>
  ...
  <nav class="p-2 navbar navbar-expand-sm bg-dark navbar-dark">
    ...
    <a class="navbar-brand" href="#container">CALENDER WEB APP 🕖</a>
  ...
  <header class="jumbotron" id="header">
    <h1 class="display-3">CALENDER WEB APP</h1>
  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="col-md-6" id="div1">
        ...
        <div class="area">
          <img src="images/lightmode.jpg " alt="" id="img">
          <ul class="circles">
            <li></li>
            <li></li>
            <li></li>
    ...
    <footer id="footer">
      ...
      <div id="footer" class="footer-content">
        <h2 class="footer-heading">CALENDER WEB APP</h2>
        ...
        <div class="flex justify-center space-x-2">
          ...
          <a id="icons" target="_blank" href="http://www.mosesrotech@gmail.com" role="button" class="m-2">
            <!-- Google -->
          ...
          <a id="icons" target="_blank" href="https://twitter.com/mosee_r" role="button" class="m-2">
            <!-- Twitter -->
        ...
        <div class="footer-bottom">
          <p>Copyright &copy;2022 CALENDER WEB APP & designed by <span>Kiprotich Moses</span></p>
        </div>
