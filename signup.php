...
<body>
    ...
    <a class="navbar-brand" href="#container">SHAJARA WEB APP 🕖</a>
  ...
  <header class="jumbotron" id="header">
    <h1 class="display-3">SHAJARA WEB APP</h1>
...
<style type="text/css">
    ...
    <footer id="footer">
      ...
      <div id="footer" class="footer-content">
        <h2 class="footer-heading">SHAJARA WEB APP</h2>
        ...
        <div class="footer-bottom">
          <p>Copyright &copy;2022 SHAJARA WEB APP & designed by <span>Kiprotich Moses</span></p>
        </div>
